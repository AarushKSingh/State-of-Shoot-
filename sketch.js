...
function spawn(){
  if (frameCount% (Math.round(random(300,550))) === 0){
    kidzz = createSprite(1090,(Math.round(random(400,600))),0,0)
    kidzz.scale = 0.6
    kidzz.velocityX = -3
    zombies.add(kidzz)
...
ladyzz.velocityX = -1
zombies.add(ladyzz)
normalzz = createSprite(1000,(Math.round(random(600,650))),0,0)
normalzz.scale = 0.8
normalzz.velocityX = -2
zombies.add(normalzz)
cakezz = createSprite(750,(Math.round(random(500,600))),0,0)
cakezz.scale = 0.8
cakezz.velocityX = -1
zombies.add(cakezz)
...
function dspawn(){
  if (frameCount% (Math.round(random(300,700))) === 0){
    dogzz = createSprite(850,(Math.round(random(500,600))),0,0)
    dogzz.scale = 0.6
    dogzz.velocityX = -3
    zombies.add(dogzz)
